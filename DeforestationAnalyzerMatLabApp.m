classdef DeforestationAnalyzerMatLabApp < handle
%
% Usage:
%     app.DeforestationAnalyzerMatLabApp

  properties
      AppPath = {'/DeforestationAnalyzerMatLab'};
	  AppClass = 'DeforestationAnalyzerMatLabApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = DeforestationAnalyzerMatLabApp()      
    ...
    function startApp(obj)
        ...
        if nargout(@app0) == 0  
			...
			obj.AppHandle = eval('app0');   
        end 
        % Increment the reference count by one    
        DeforestationAnalyzerMatLabApp.refcount(obj.Increment);
